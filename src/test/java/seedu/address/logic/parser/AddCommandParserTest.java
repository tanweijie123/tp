...
import static seedu.address.logic.commands.CommandTestUtil.TAG_DESC_ALLERGY;
import static seedu.address.logic.commands.CommandTestUtil.TAG_DESC_INJURY;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_ALLERGY).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_ALLERGY, new AddCommand(expectedPerson));
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_ALLERGY, VALID_TAG_INJURY)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_INJURY + TAG_DESC_ALLERGY, new AddCommand(expectedPersonMultipleTags));
    }
