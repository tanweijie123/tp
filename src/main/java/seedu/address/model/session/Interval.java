...
public class Interval {
    ...
    public static String MESSAGE_START_TIME_CONSTRAINTS = "Start time must be a valid date and time and follows "
            + "dd/MM/yyyy HHmm pattern";
    public static String MESSAGE_END_TIME_CONSTRAINTS = "End time must be a valid date and time and follows "
            + "dd/MM/yyyy HHmm pattern";
