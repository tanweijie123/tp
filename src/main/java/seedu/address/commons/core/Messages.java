...
public class Messages {
    ...
    public static final String MESSAGE_UPCOMING_WEEK_SESSIONS_OVERVIEW = "Weekly timetable displayed!";
    public static final String MESSAGE_ALL_SESSIONS_OVERVIEW = "All sessions displayed!";
}
